      ...
      <ScrollView contentContainerStyle={{ height: "100%" }}>
        ...
        >
          ...
          <LottieView
            ...
            source={require('../animations/funds.json')}
          />
          ...
          <TouchableOpacity onPress={() => router.push('/sign-up')} style={{width: 60, height: 60, borderWidth: 2, borderRadius: 30, marginTop: 40, justifyContent: 'center', alignItems: 'center', borderColor: '#9378FF'}}>
